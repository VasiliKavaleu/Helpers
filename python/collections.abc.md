Модуль collections.abc содержит абстрактные базовые классы, определяющие API для контейнерных структур данных, встроенных в Python и предоставляемых модулем collections.
